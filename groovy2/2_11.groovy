...
Employee e1=new Employee(name:'Anusha',age:23 as byte,dept:'Finance',e_no:101,salary:20000)
Employee e2=new Employee(name:'Nimisha',age:53 as byte,dept:'Marketing',e_no:102,salary:2000)
Employee e3=new Employee(name:'Geetha',age:83 as byte,dept:'Manufacturing',e_no:103,salary:3000)
Employee e4=new Employee(name:'Sudhakaran',age:13 as byte,dept:'Marketing',e_no:104,salary:4000)
